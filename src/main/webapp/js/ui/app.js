...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                height = _calculateFixedSidebarViewportHeight()- $('.footer').height();
            } else {
                height = sidebar.height()  + 20;
            }
            if (height >= content.height()) {
                content.attr('style', 'min-height:' + height + 'px !important');
                content.find('.container-fluid').attr('style', 'min-height:' + (height - 15) + 'px !important');
            } 
        }          
    }
    ...
    return {
        ...
        init: function () {
            ...
            //handleFixedSidebarHoverable(); // handles fixed sidebar on hover effect 三级菜单显示隐藏
            handleSidebarMenu(); // handles main menu
            handleHorizontalMenu(); // handles horizontal menu
            handleSidebarToggler(); // handles sidebar hide/show            
            handleFixInputPlaceholderForIE(); // fixes/enables html5 placeholder attribute for IE9, IE8
            handleGoTop(); //handles scroll to top functionality in the footer 返回到顶部
